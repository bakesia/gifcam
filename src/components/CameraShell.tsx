...
export function CameraShell({ frames, selectedFrame, totalDurationMs, dimensionsLabel, outputDimensions, defaultDelayMs, outputSettings, useCanvasPreview, onAddFiles, onOpenFilePicker, onDefaultDelayChange, onApplyDelayToAll, onOutputSettingsChange, onVisualOutputSettingsChange }: CameraShellProps) {
  return (
    <>
